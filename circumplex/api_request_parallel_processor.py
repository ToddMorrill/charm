...
nohup \
python -u api_request_parallel_processor.py \
  --requests_filepath data/gpt_requests.jsonl \
  --save_filepath data/gpt_requests_results.jsonl \
  --request_url https://api.openai.com/v1/chat/completions \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  --token_encoding_name gpt-3.5-turbo-0301 \
  --max_attempts 5 \
  --logging_level 20 \
> output.log 2>&1 &
